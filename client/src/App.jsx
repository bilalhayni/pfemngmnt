...
// Role constants - imported from AuthContext
const ROLES = {
  PROFESSOR: 0,
  CHEF_DEPARTEMENT: 1,
  STUDENT: 2,
      ...
      <AuthProvider>
        <Suspense fallback={<Loading fullPage message="Chargement de l'application..." />}>
          <Routes>
            ...
            <Route element={<PrivateRoute allowedRoles={ROLES.CHEF_DEPARTEMENT} />}>
            ...
            <Route path="/prof" element={<PrivateRoute allowedRoles={ROLES.PROFESSOR} />}>
            ...
            <Route path="/student" element={<PrivateRoute allowedRoles={ROLES.STUDENT} />}>
